...
use jupiter_core::{
    amm::Amm,
    amms::{
        obsidian_amm::ObsidianAmm, spl_token_swap_amm::SplTokenSwapAmm,
...
test_exact_in_amms! {
    ...
    // TODO: Uncomment when you have a real Obsidian pool ID and snapshot
    (OBSIDIAN_SOL_USDC_POOL, ObsidianAmm, None),
}
